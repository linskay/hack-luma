...
class KubeTrainerControllerTest {
    ...
    void shouldSubmitYamlSuccessfully() {
        // Given
        when(kubeTrainerService.applyYaml(any(KubeSubmission.class))).thenReturn(mockSuccessResult);
    ...
    void shouldHandleFailedSubmission() {
        // Given
        when(kubeTrainerService.applyYaml(any(KubeSubmission.class))).thenReturn(mockFailureResult);
